    ...
    private void SelectionChanged()
    {
        ...
        switch (selectionType) {
            ...
            case BehaviorSelectionType.Seek:
                marker.transform.position = new Vector3(20, 1, 20);
                marker.SetActive(true);
                marker.animation["MarkerSeek"].time = 0;
                marker.animation["MarkerSeek"].speed = 1;
                marker.animation.Play("MarkerSeek");
                mainBot.transform.position = new Vector3(-20, 1, -20);
                mainBot.transform.eulerAngles = new Vector3(0, 180, 0);
                mainBot.SetActive(true);
                break;
            case BehaviorSelectionType.Flee:
                marker.transform.position = new Vector3(20, 1, 20);
                marker.SetActive(true);
                marker.animation["MarkerFlee"].time = 0;
                marker.animation["MarkerFlee"].speed = 1;
                marker.animation.Play("MarkerFlee");
            ...
            case BehaviorSelectionType.Pursue:
                marker.transform.position = new Vector3(20, 1, 20);
                marker.SetActive(true);
                marker.animation["MarkerPersue"].time = 0;
                marker.animation["MarkerPersue"].speed = 1;
                marker.animation.Play("MarkerPersue");
            ...
            case BehaviorSelectionType.Evade:
                marker.transform.position = new Vector3(20, 1, 20);
                marker.SetActive(true);
                marker.animation["MarkerEvade"].time = 0;
                marker.animation["MarkerEvade"].speed = 1;
                marker.animation.Play("MarkerEvade");
