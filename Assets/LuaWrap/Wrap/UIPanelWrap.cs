...
public class UIPanelWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UIPanel", typeof(UIPanel), regs, fields, "UIRect");
	}
	...
	static int get_onGeometryUpdated(IntPtr L)
	{
		...
		LuaScriptMgr.PushObject(L, obj.onGeometryUpdated);
		return 1;
	}
	...
	static int get_renderQueue(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		LuaScriptMgr.PushEnum(L, obj.renderQueue);
		return 1;
	}
	...
	static int get_drawCallClipRange(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		LuaScriptMgr.PushValue(L, obj.drawCallClipRange);
		return 1;
	}
	...
	static int get_onClipMove(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		LuaScriptMgr.PushObject(L, obj.onClipMove);
		return 1;
	}
	...
	static int get_drawCallOffset(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		LuaScriptMgr.PushValue(L, obj.drawCallOffset);
		return 1;
	}
	...
	static int get_clipping(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		LuaScriptMgr.PushEnum(L, obj.clipping);
		return 1;
	}
	...
	static int get_clipOffset(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		LuaScriptMgr.PushValue(L, obj.clipOffset);
		return 1;
	}
	...
	static int get_baseClipRegion(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		LuaScriptMgr.PushValue(L, obj.baseClipRegion);
		return 1;
	}
	...
	static int get_finalClipRegion(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		LuaScriptMgr.PushValue(L, obj.finalClipRegion);
		return 1;
	}
	...
	static int get_clipSoftness(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		LuaScriptMgr.PushValue(L, obj.clipSoftness);
		return 1;
	}
	...
	static int set_drawCallClipRange(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		obj.drawCallClipRange = LuaScriptMgr.GetNetObject<Vector4>(L, 3);
		return 0;
	}
	...
	static int set_clipOffset(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		obj.clipOffset = LuaScriptMgr.GetNetObject<Vector2>(L, 3);
		return 0;
	}
	...
	static int set_baseClipRegion(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		obj.baseClipRegion = LuaScriptMgr.GetNetObject<Vector4>(L, 3);
		return 0;
	}
	...
	static int set_clipSoftness(IntPtr L)
	{
		...
		UIPanel obj = (UIPanel)o;
		obj.clipSoftness = LuaScriptMgr.GetNetObject<Vector2>(L, 3);
		return 0;
	}
	...
	static int IsVisible(IntPtr L)
	{
		...
		Type[] types0 = {typeof(UIPanel), typeof(UIWidget)};
		Type[] types1 = {typeof(UIPanel), typeof(Vector3)};
