...
public class TweenPositionWrap
{
	...
	static int _CreateTweenPosition(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: TweenPosition.New");
		}
	...
	{
		LuaScriptMgr.Push(L, typeof(TweenPosition));
		return 1;
	}

	public static void Register(IntPtr L)
	{
		LuaScriptMgr.RegisterLib(L, "TweenPosition", typeof(TweenPosition), regs, fields, "UITweener");
	}
