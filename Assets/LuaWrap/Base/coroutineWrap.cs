...
public class yieldWrap 
{
    ...
    {
		LuaScriptMgr.RegisterLib(L, "yield", regs);
    }
	...
	static int WaitForSeconds(IntPtr L)
    {
        ...
        LuaCoroutine.Timer.Instance.AddTimer(arg0, 1, action);
	...
	static int Yield(IntPtr L)
    {
        ...
        LuaCoroutine.Timer.Instance.Yield(1, action);
        return LuaDLL.lua_yield(L, 0);
    }    
    ...
    static int WaitForEndOfFrame(IntPtr L)
    {
        ...
        LuaCoroutine.Timer.Instance.WaitEndOfFrame(action);
        return LuaDLL.lua_yield(L, 0);
    } 
